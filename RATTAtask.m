...
if design.Session == 1 % if test
    if mod(design.subjectId,2) == 1 % if subject Id is an odd number
        ConditionList=AllList((AllList.TestDay==1),:); % give the 1st list
    else
        ConditionList=AllList((AllList.TestDay==2),:);
    end
else % if retest
    if mod(design.subjectId,2) == 1 % if subject Id is an odd number
        ConditionList=AllList((AllList.TestDay==2),:); % give the 2nd list
    else
        ConditionList=AllList((AllList.TestDay==1),:);
    end
end
