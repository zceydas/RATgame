...
%                     numchoices, centerlabel, numcolor, Qtextcolor, buttondelay, ydim);

% CS: ADDED a Qtextcolor option that changes the text color of the question
% and changed the nargin variable from 10 to 11
...
function answer = Likert(window, textcolor,questiontext, leftlabel, rightlabel, ...
    confirmcolor, numchoices, centerlabel, numcolor, Qtextcolor, buttondelay, ydim)
...
%% WRITE THE QUESTION
    ...
    WriteLine(window, questiontext, Qtextcolor, buttonmargin, buttonmargin*2, windowsize(2)+buttonmargin);  
